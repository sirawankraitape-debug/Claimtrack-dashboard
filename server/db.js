...
const DEFAULT_STATUSES = [
  ...
  { key:'delay_analyze', label:'เคสวิเคราะห์ล่าช้า', color:'#EA580C', grp:'ดำเนินการ', terminal:false, sort_order:6  },
  { key:'no_driven',     label:'ไม่มีใน Drive N',                    color:'#64748B', grp:'ดำเนินการ',    terminal:false, sort_order:7  },
  { key:'not_accepted',  label:'ไม่รับเคส (เพิ่มข้อมูล)',             color:'#9333EA', grp:'ดำเนินการ',    terminal:false, sort_order:8  },
  { key:'consider_co',   label:'ขอพิจารณาลงบริษัท',                 color:'#EC4899', grp:'ดำเนินการ',    terminal:false, sort_order:9  },
  { key:'CPF',           label:'CPF',                                color:'#F43F5E', grp:'ดำเนินการ',    terminal:false, sort_order:10 },
  { key:'fraud',         label:'เคสทุจริต',                          color:'#DC2626', grp:'ดำเนินการ',    terminal:true,  sort_order:11 },
  { key:'closed',        label:'ปิดจบไม่เคลม',                      color:'#10B981', grp:'ดำเนินการ',    terminal:true,  sort_order:12 },
  { key:'A00', label:'A00 อยู่ระหว่างการพิจารณา',                   color:'#38BDF8', grp:'สถานะเคลม',    terminal:false, sort_order:13 },
  { key:'A01', label:'A01 อยู่ระหว่างการส่งเอกสารประกอบการเคลม',    color:'#818CF8', grp:'สถานะเคลม',    terminal:false, sort_order:14 },
  { key:'A02', label:'A02 อยู่ระหว่างการตรวจสอบเอกสาร',             color:'#A78BFA', grp:'สถานะเคลม',    terminal:false, sort_order:15 },
  { key:'A03', label:'A03 อยู่ระหว่างการโอนเงิน',                   color:'#F472B6', grp:'สถานะเคลม',    terminal:false, sort_order:16 },
  { key:'A04', label:'A04 โอนเงิน',                                color:'#34D399', grp:'สถานะเคลม',    terminal:true,  sort_order:17 },
  { key:'A89', label:'A89 ปิดจบ ไม่เคลม',                          color:'#94A3B8', grp:'สถานะเคลม',    terminal:true,  sort_order:18 },
